...
<template>
  <div class="relative py-8" 
    ...
    <div class="border-y-2 pt-16 pb-8" 
      :class="{ 'md:px-12 mx-8 flex-1' : router.currentRoute.value.name === 'home' && !show_options,
    ...
    <template v-if="router.currentRoute.value.name === 'home'">
      ...
      <img src="./assets/bg_bottom.png" alt="imagem de fundo 2" class="-z-10 w-full absolute bottom-0 lg:bottom-[-60px]"/>
    </template>
